...
class ChatDefence {
    ...
    static wordCheck(username, message, userstate, client) {
        let check = false;
        const inList = ['pr_'];
        const list = ['ava', 'аватария', 'ава', 'блять', 'хуй', 'пизда', 'уебан', 'чмо', 'чсв', 'уебок', 'еблан', 'мразь', 'член', 'ебать', 'ебу', 'выебу', 'cock', 'cunt', 'ебаль', 'хуев', 'хуёв', 'ебет', 'ебёт', 'заебал', 'заебали', 'cvmask', 'cvhazmat',
